...
%\solution{pr:3} First of all, note that the function is only defined for $\vct{x}$ such that $\mtx{A}\vct{x}\leq \vct{b}$. This is the {\em domain} of the function. 
%
